...
pod_leases = Table("pod_leases", metadata,
    Column("lease_id", String, primary_key=True),
    Column("task_id", String, ForeignKey("tasks.task_id"), nullable=False),
    Column("org_id", String, ForeignKey("organizations.org_id"), nullable=False),
    Column("provider", String, nullable=False),
    Column("pod_name", String, nullable=False, unique=True),
    Column("pod_id", String, unique=True),
    Column("state", String, nullable=False),
    Column("request_json", Text, nullable=False),
    Column("hourly_cap_cents", Integer, nullable=False),
    Column("lease_seconds", Integer, nullable=False),
    Column("reservation_id", String, ForeignKey("quota_records.record_id"), nullable=False),
    Column("quoted_gpu_hourly_usd", String),
    Column("reported_hourly_usd", String),
    Column("billing_total_usd", String),
    Column("created_at", String, nullable=False),
    ...
    CheckConstraint("state IN ('creating','active','delete_pending','billing_pending','closed','overrun','failed')"),
    CheckConstraint("hourly_cap_cents > 0"),
    CheckConstraint("lease_seconds BETWEEN 1 AND 86400"),
)
Index("idx_pod_leases_due", pod_leases.c.state, pod_leases.c.expires_at)
